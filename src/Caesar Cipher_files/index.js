const btn= document.getElementById("cifradod");
    ...
    console.log(letrasTranformadas);



window.cipher.encode(offset, letrasTranformadas);
...
//const guardarNamber= parseInt(namBer);
//console.log(guardarNamber);
//window.cipher.encode(guardarNamber);
